			...
			<div class="li" v-for="(data,i) in papers" :key="data.i">
				...
				<div class="right">
					...
					<div class="del">
						...
						<el-tooltip class="item" effect="dark" content="下载试卷" placement="top-start">
		...
		methods: {
			...
			studentDownloadList(data) {
				...
				if (data.affix) {
					...
					selectBySchoolIdAndPaperIdAndClassId(this.pageNum1, this.pageSize1, this.testPaperId, this.classId, this.schoolId)
						.then(res => {
			...
			handleCurrentChange1(val) {
				...
				selectBySchoolIdAndPaperIdAndClassId(this.pageNum1, this.pageSize1, this.testPaperId, this.classId, this.schoolId).then(
					res => {
						this.tableData = res.data.data.list
						this.total1 = res.data.data.total
						this.currentPage1 = res.data.data.pageNum
