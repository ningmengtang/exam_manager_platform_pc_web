		...
		<div class="particular">
			<div class="li" v-for="(item,i) in paperList" :key="item.i">
				...
				<div class="right">
					...
					<i class="icon" :class="(item.studentExam.finish_status==2||item.studentExam.finish_status==1)?'el-icon-caret-right font-i3':(item.status==1||item.studentExam.finish_status!=1||item.status==2)?'el-icon-time font-i':item.studentExam.finish_status==5&&item.status==0?'el-icon-check font-i1':'el-icon-close font-i'"></i>
